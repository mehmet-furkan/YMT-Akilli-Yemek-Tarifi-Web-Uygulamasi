...
# Akıllı Yemek Tarifi Web Sitesi Haftalık Görev:
## Proje Yönetimi ve İş Birliği Araçları Kurulumu
---

AMAÇ:
Geliştirici ekip arasında üretilen kodların düzgün biçimde aktarılabilmesi, Projede yapılacak değişimlerin her bir üyeye düzgün bir biçimde ulaşması, üyelerin birbirinden haberdar olması vb işlevleri yerine getirebilecek bir uygulama seçilerek kurulması.
...
| :--- | :--- | :--- |
| Jirro | Agile desteği, Birçok ek özellik | Büyük  ekipler için, öğrenmesi zor |
|Trello| Hızlı öğrenim, Güçlü görsellik | İleri düzey raporlama yok |
| Slack| Yüksek iletişim, Mobil desteği | Proje yönetimi odaklı değil |
...
Asana, Jirro'dan daha kolay öğrenilebilir olmasının yanında ondan sonraki en kabiliyetli program olarak belirlenmiştir. Ancak ücretsiz sürüm sınırlandırmaları olması uzun vadeli çalışma sırasında sorunlara sebep olabileceği endişesi ile reddedilmiştir.
