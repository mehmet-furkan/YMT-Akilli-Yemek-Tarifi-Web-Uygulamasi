...
export default function RecipeDetailPage() {
  ...
  return (
    <main className="min-h-screen bg-stone-50 pb-16">
      {/* Hero image */}
      <div className="relative w-full aspect-[3/2] sm:aspect-[16/7] bg-amber-100 overflow-hidden">
        {recipe.imageUrl ? (
          <img
            src={recipe.imageUrl}
            alt={recipe.title}
        ...
        <Link
          to="/"
          className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm text-stone-700 text-sm font-medium px-3 py-1.5 rounded-full shadow-sm hover:bg-white transition-colors flex items-center gap-1.5"
        >
      ...
      <div className="max-w-3xl mx-auto px-4 -mt-4 sm:mt-6">
        {/* Card wrapper */}
        <div className="bg-white rounded-2xl shadow-sm border border-amber-100 p-5 sm:p-8">
          {/* Category + Difficulty */}
...
function RecipeDetailSkeleton() {
  return (
    <main className="min-h-screen bg-stone-50 pb-16 animate-pulse">
      <div className="w-full aspect-[3/2] sm:aspect-[16/7] bg-amber-100" />
      <div className="max-w-3xl mx-auto px-4 mt-6">
        <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-amber-100 space-y-4">
